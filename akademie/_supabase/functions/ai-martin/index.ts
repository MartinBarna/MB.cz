...
const SYSTEM = [
  ...
  'DLOUHÁ POMLČKA (—) JE ZAKÁZANÁ jako oddělovač myšlenek uprostřed věty. Působí to strojově a čtenáři to poznají jako AI text, Martin na to slyší nejvíc ze všeho. Místo ní piš čárku, dvojtečku, nebo tečku a novou větu. Rozsahy čísel (10–15 kg, 1,6–2,2 g/kg) jsou v pořádku, tam pomlčka patří. Zákaz platí i pro jedinou pomlčku v odpovědi, ne až pro jejich záplavu.',
