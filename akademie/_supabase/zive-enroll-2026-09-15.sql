-- ZACHRANA ZIVEHO ZNENI ENROLL FUNKCI (15. 9. 2026, 70. sef)
...
--
-- DUVOD: zive funkce jsou NOVEJSI nez git (upsell-nevytrhavat.sql a upsell-sequences.sql
-- obe popisuji tutez funkci a obe jinak). Nasazeni ze starsiho souboru by ticho smazalo
-- ochrany z 8. 8. a 6. 9. 2026. Tenhle soubor je otisk ZIVEHO stavu PRED zmenou z 15. 9.
-- Nic se z nej nenasazuje automaticky; je to zaloha a referencni bod pro diff.
--
-- GRANTY v dobe otisku (proacl u vsech ctyr funkci stejne):
--   {postgres=X/postgres,service_role=X/postgres}
--   tedy EXECUTE ma jen postgres a service_role, anon ani authenticated NE.
--   Po jakekoli migraci, ktera funkci DROPuje, se proacl musi rovnat temhle hodnotam.

-- ============================================================
-- enroll_into_longtail(integer)   proacl: {postgres=X/postgres,service_role=X/postgres}
-- ============================================================
...
-- ============================================================
-- enroll_into_nurture_videokurz(integer)   proacl: {postgres=X/postgres,service_role=X/postgres}
-- ============================================================
...
-- ============================================================
-- enroll_into_upsell_academy(integer)   proacl: {postgres=X/postgres,service_role=X/postgres}
-- ============================================================
...
-- ============================================================
-- enroll_into_upsell_coaching(integer)   proacl: {postgres=X/postgres,service_role=X/postgres}
-- ============================================================
