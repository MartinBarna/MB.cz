...
**Subject:** `Tvůj videokurz má nový domov 🎬`
**Preheader:** `Všech 182 videí + materiály na jednom místě. Přístup si vytvoříš za minutu.`
```json
[
  {"t":"p","html":"Ahoj{{fn_space}},"},
  {"t":"p","html":"mám pro Tebe dobrou zprávu. Tvůj <strong>Videokurz výživy</strong> dostal úplně novou členskou sekci — přehlednější, rychlejší, všechno na jednom místě. Máš ji <strong>v ceně</strong>, nic znovu neplatíš."},
...
**Subject:** `Předělal jsem členskou sekci — a máš v ní dárek 💪`
