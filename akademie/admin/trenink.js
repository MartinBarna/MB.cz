...
(function (global) {
  ...
  var WG_URL = '/assets/workout-gen.js?v=20260907b';
  ...
  function pripravEngine() {
    ...
    if (!global.TreninkSablona) kroky.push(nactiSkript('/akademie/admin/trenink-sablona.js?v=20260906e'));
