...
<style>
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .cover .mark { width:46px; height:46px; border-radius:12px; background:#EBB12C; color:#161616; font-weight:800; font-size:1.1rem; display:flex; align-items:center; justify-content:center; }
  .cover .kick { display:inline-block; margin-top:16px; background:rgba(235,177,44,.18); color:#F6CD63; font-weight:700; font-size:8.5pt; letter-spacing:1.5px; text-transform:uppercase; padding:5px 13px; border-radius:50px; }
  ...
  .praxe { background:#fff8f0; border:1px solid #f3dcbd; border-left:4px solid #EBB12C; border-radius:10px; padding:11px 15px; margin:11px 0; }
  ...
  blockquote { border-left:4px solid #EBB12C; padding:4px 0 4px 14px; color:#5a5045; font-style:italic; margin:11px 0; }
