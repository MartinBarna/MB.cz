...
(function () {
  try {
    ...
    st.textContent =
      ...
      '.la-btn{display:inline-flex;align-items:center;gap:8px;background:linear-gradient(145deg,var(--gold-2,#F6CD63),var(--gold,#EBB12C));color:#1A1222;border:none;font-weight:700;font-size:.92rem;padding:10px 18px;border-radius:50px;cursor:pointer;font-family:inherit;transition:transform .15s,box-shadow .15s;box-shadow:0 6px 16px rgba(235,177,44,.18)}' +
      '.la-btn:hover{transform:translateY(-1px)}.la-btn.on{box-shadow:0 0 0 3px rgba(235,177,44,.22)}' +
