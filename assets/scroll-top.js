...
(function () {
  ...
  ready(function () {
    ...
    function place() {
      ...
      if (shown) {
        b.style.bottom = floor + 'px';                                  // "nahoru" těsně nad lištou
        if (wa) wa.style.bottom = (floor + b.offsetHeight + gap) + 'px'; // WhatsApp nad "nahoru"
      } else if (wa) {
        wa.style.bottom = floor + 'px';                                 // skryté → WhatsApp v rohu / nad lištou
      }
    }
