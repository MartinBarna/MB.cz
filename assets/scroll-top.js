...
(function () {
  ...
  ready(function () {
    ...
    var css = ''
      ...
      + '.mb-mmhost.mbopen .mb-mmburger span:nth-child(1){transform:translateY(7px) rotate(45deg);}'
      + '.mb-mmhost.mbopen .mb-mmburger span:nth-child(2){opacity:0;}'
      + '.mb-mmhost.mbopen .mb-mmburger span:nth-child(3){transform:translateY(-7px) rotate(-45deg);}'
