  ...
  try {
    ...
    function ensureStyle() {
      ...
      s.textContent = [
        ...
        '.ba-au::before{content:"";position:absolute;left:-50px;top:-50px;width:200px;height:200px;border-radius:50%;background:radial-gradient(circle,rgba(235,177,44,.2),transparent 65%);pointer-events:none;}',
        ...
        '.ba-au .kick{display:inline-block;background:rgba(235,177,44,.14);border:1px solid rgba(235,177,44,.4);color:#F6CD63;font-weight:700;font-size:.68rem;letter-spacing:.13em;text-transform:uppercase;padding:5px 13px;border-radius:50px;}',
        '.ba-au h3{color:#fff;font-size:1.5rem;line-height:1.18;margin:14px 0 8px;letter-spacing:-.02em;}',
        '.ba-au h3 b{color:#F6CD63;}',
    ...
    function show() {
      ...
      ov.innerHTML =
        ...
        '<ul><li>24 modulů a 256 lekcí + diagramy a kvízy</li><li>Nástroje pro trenéry: generátory + databáze 125 cviků</li><li>Certifikát Barna Academy</li><li>Doživotní přístup, i budoucí obsah</li></ul>' +
